...
class GAN_trainer():
    ...
    def train(self, x_data, y_data, epochs=300, pre_trained_path="data/pre-train/aqueousGlucose/cvae_gan_split:17.pth", pre_training=False):
